...
public class RelatorioService {
	...
	public byte[] gerarRelatorioControleVeiculos(PeriodoRelatorio periodoRelatorio) throws Exception {
		...
		InputStream inputStream = this.getClass()
				.getResourceAsStream("/relatorios/relatorio_movimentacao_veiculos.jasper");
	...
	public byte[] gerarRelatorioControleVisitantes(PeriodoRelatorio periodoRelatorio) throws Exception {
		Date dataInicio = Date.from(LocalDateTime.of(periodoRelatorio.getDataInicio(), LocalTime.of(0, 0, 0))
				.atZone(ZoneId.systemDefault()).toInstant());
		Date dataFim = Date.from(LocalDateTime.of(periodoRelatorio.getDataFim(), LocalTime.of(23, 59, 59))
				.atZone(ZoneId.systemDefault()).toInstant());
		...
		InputStream inputStream = this.getClass()
				.getResourceAsStream("/relatorios/relatorio_movimentacao_visitantes.jasper");
