...
public class ControleVisitantesController {
	...
	@PostMapping("/novo")
	public ModelAndView salvar(Controle controle, BindingResult result, RedirectAttributes attributes,
	...
	public ModelAndView lancar(Controle controle, BindingResult result, RedirectAttributes attributes,
			@AuthenticationPrincipal UsuarioSistema usuarioSistema) {
		validarControle(controle, result);
		if (result.hasErrors()) {
			return novo(controle);
	...
	public ModelAndView finalizar(Controle controle, BindingResult result, RedirectAttributes attributes,
			@AuthenticationPrincipal UsuarioSistema usuarioSistema) {
		validarControle(controle, result);
		if (result.hasErrors()) {
			return novo(controle);
	...
	public ModelAndView cancelar(Controle controle, BindingResult result, RedirectAttributes attributes,
			@AuthenticationPrincipal UsuarioSistema usuarioSistema) {
		try {
